...
# Ensure we can import ldf
sys.path.append(os.getcwd())

from fastapi.testclient import TestClient
from sqlmodel import Session, SQLModel, create_engine
from ldf.research.api.main import app
from ldf.research.db import ActMetadata

# client = TestClient(app) # Removed global

from sqlalchemy import inspect
import ldf.research.db
...
def test_add_act_flow():
    ...
    from ldf.research.db import ActMetadata, TelemetryLog, ActAnalysis, AnalysisHistory
    ...
    # We define a side_effect to check what engine is used in main
    def debug_engine():
        from ldf.research.api import main
        print(f"Engine in main during patch: {id(main.engine)}")
        return test_engine

    with patch("ldf.research.api.main.engine", test_engine) as mocked_engine, \
         patch("ldf.research.db.engine", test_engine), \
         patch("ldf.research.api.main.get_head_path", return_value=temp_tsv), \
