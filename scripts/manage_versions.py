...
def main():
    parser = argparse.ArgumentParser(description="Manage Act Data Versions")
    ...
    apply_parser.add_argument("patch_file", help="Path to JSON patch file")
    ...
    if args.command == "init":
        ...
        apply_patch(Path(args.patch_file))
    else:
        parser.print_help()
